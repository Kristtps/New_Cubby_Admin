...
const translations = {
    en: {
        ...
        'inventory.subtitle': 'Monitor and adjust cash amounts inside device bill compartments.',
        'inventory.totalCompartmentCash': 'Total Compartment Cash',
        'inventory.lastRefilled': 'Last Refilled',
        'inventory.lastRefillAmount': 'Last Refill Amount',
        'inventory.selectDevice': 'Select Device',
        'inventory.deviceDetails': 'Device Details',
        'inventory.status': 'Status',
        'inventory.location': 'Location',
        'inventory.code': 'Device Code',
        'inventory.manageCash': 'Manage Cash',
        'inventory.action': 'Action',
        'inventory.amount': 'Amount (PHP)',
        'inventory.notes': 'Notes / Remarks',
        'inventory.notesPlaceholder': 'E.g., Manual collection, float adjustment...',
        'inventory.submitAction': 'Submit Adjustment',
        'inventory.historyTitle': 'Inventory Event History',
        'inventory.actionAll': 'All Actions',
        'inventory.actionAdd': 'Manual Add',
        'inventory.actionDeduct': 'Manual Deduct',
        'inventory.actionRefill': 'Refill',
        'inventory.historyAction': 'ACTION',
        'inventory.historyBeforeAfter': 'BEFORE / AFTER',
        'inventory.historyPerformedBy': 'PERFORMED BY',
        'inventory.historyDate': 'DATE & TIME',
        'inventory.historyNotes': 'NOTES',
    ...
    tl: {
        ...
        // Device Inventory Page (Tagalog)
        'inventory.title': 'Imbentaryo ng Device',
        'inventory.subtitle': 'Subaybayan at i-adjust ang pera sa loob ng compartment ng barya/papel ng device.',
        'inventory.totalCompartmentCash': 'Kabuuang Pera sa Compartment',
        'inventory.lastRefilled': 'Huling Ni-refill',
        'inventory.lastRefillAmount': 'Halaga ng Huling Refill',
        'inventory.selectDevice': 'Pumili ng Device',
        'inventory.deviceDetails': 'Mga Detalye ng Device',
        'inventory.status': 'Katayuan',
        'inventory.location': 'Lokasyon',
        'inventory.code': 'Code ng Device',
        'inventory.manageCash': 'Pamahalaan ang Pera',
        'inventory.action': 'Aksyon',
        'inventory.amount': 'Halaga (PHP)',
        'inventory.notes': 'Mga Tala / Remarks',
        'inventory.notesPlaceholder': 'Hal., Manu-manong koleksyon, float adjustment...',
        'inventory.submitAction': 'I-submit ang Adjustment',
        'inventory.historyTitle': 'Kasaysayan ng Imbentaryo',
        'inventory.actionAll': 'Lahat ng Aksyon',
        'inventory.actionAdd': 'Manu-manong Dagdag',
        'inventory.actionDeduct': 'Manu-manong Bawas',
        'inventory.actionRefill': 'Refill',
        'inventory.historyAction': 'AKSYON',
        'inventory.historyBeforeAfter': 'BAGO / PAGKATAPOS',
        'inventory.historyPerformedBy': 'NAGSagawa',
        'inventory.historyDate': 'PETSA at ORAS',
        'inventory.historyNotes': 'MGA TALA',
